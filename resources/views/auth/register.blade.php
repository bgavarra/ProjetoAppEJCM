                ...
                <div class="panel-body">
                    <form class="form-horizontal" method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group{{ $errors->has('categorias') ? ' has-error' : '' }}">
                            <label for="categorias" class="col-md-4 control-label">Categoria de Serviço</label>

                            <div class="col-md-6">
                                <input id="categorias" type="text" class="form-control" name="categorias" value="{{ old('categorias') }}" required autofocus>
